...
- [Log 提交详情面板](../docs/features/log-commit-detail-panel.md) — 点击提交行于图右侧 webview 内分栏打开常驻详情面板（上半 Changed Files、下半提交信息：引用分组/完整消息/统计/SHA/GitHub）；面板可见性 ⟺ 选中态，替代原悬停浮层。
...
- [发布说明](../releases/README.md) — 各正式版 Release Notes（GitHub Release 正文单一事实源；最新 [v0.0.16](../releases/v0.0.16.md)）。
